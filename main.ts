...
//% color="#019858" weight=10 icon="\f836"
namespace bmsmotor {
    ...
    */
    ...
    //% blockId=bmsmotor_matrix_draw block="Matrix Draw|X %x|Y %y"
    //% weight=69
    ...
    //% blockId=bmsmotor_matrix_refresh block="Matrix Refresh"
    //% weight=69
	...
	/*
    //% blockId=bmsmotor_matrix_clean block="Matrix Clean|X %x|Y %y"
    //% weight=68
	...
	*/
    ...
    //% blockId=bmsmotor_matrix_clear block="Matrix Clear"
    //% weight=65
    //% blockGap=50
